...
public class RideController {
    ...
    public ResponseEntity<RideResponse> requestRide(
        ...
        log.info("ride request received from rider: {}", rideRequest.riderId());
